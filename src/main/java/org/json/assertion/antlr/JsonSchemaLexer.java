...
public class JsonSchemaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "IDENTIFIER", "DATATYPE", "CLASS_NAME", "BOOLEAN", "STRING", 
			"ESCAPE", "UNICODE", "HEXADECIMAL", "DECIMAL", "FLOAT", "INTEGER", "EXPONENT", 
			"INTDIGIT", "DIGIT", "NONDIGIT", "OPTIONAL", "NULL", "WHITE_SPACE", "MULTILINE_COMMENTS", 
			"LINE_COMMENTS"
		};
	}
